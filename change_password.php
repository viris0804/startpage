...
<body>
<div id="container">
<div id="wb_MasterPage2" style="position:absolute;left:0px;top:0px;width:799px;height:833px;z-index:9;">
...
<a href="https://www.wysiwygwebbuilder.com" target="_blank"><img src="images/builtwithwwb17.png" alt="WYSIWYG Web Builder" style="position:absolute;left:85px;top:698px;margin: 0;border-width:0;z-index:250" width="88" height="31"></a>
<div id="wb_ChangePassword1" style="position:absolute;left:258px;top:422px;width:505px;height:239px;z-index:11;">
<form name="changepasswordform" method="post" action="<?php echo basename(__FILE__); ?>" id="changepasswordform">
...
<tr>
   <td style="text-align:right;vertical-align:bottom" colspan="2"><input class="button" type="submit" name="changepassword" value="Change Password" id="changepassword"></td>
</tr>
</table>
</form>
</div>
<div id="wb_Text1" style="position:absolute;left:267px;top:222px;width:488px;height:33px;text-align:center;z-index:12;">
<span style="color:#006BF5;font-family:Tahoma;font-size:27px;"><strong>Change Password</strong></span></div>
<div id="wb_Text2" style="position:absolute;left:259px;top:296px;width:520px;height:111px;text-align:center;z-index:13;">
<span style="color:#000000;font-family:Arial;font-size:13px;">The <strong>Change Password</strong> object allows users to change their password.<br>The user must be logged in to be able to change the password.<br><br><strong><br>Important: This page must have the File Extension 'php'!</strong><br>You can change the file extesion of a page in the Page Properties.<br></span></div>
</div>
</body>
</html>